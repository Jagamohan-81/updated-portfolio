    ...
    <>
      ...
      <section className="w-[100%] flex flex-col flex-nowrap items-center justify-center gap-7 px-mobileBound sm:px-8 sm:gap-8 md:gap-9 lg:gap-10">
        ...
        <p className="text-justify">
          Hello, and welcome! I&apos;m Jagamohan, a web developer with a passion
          for solving visions through exceptional web experiences. With a blend
          of creativity and technical expertise, I take pride in crafting
