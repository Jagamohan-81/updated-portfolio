  ...
  return (
    <dl className="mt-6 grid justify-items-center items-start justify-center gap-8 md:gap-9 grid-cols-[repeat(1,1fr)] md:grid-cols-[repeat(2,1fr)] lg:grid-cols-[repeat(3,1fr)] sm:mt-7 md:mt-8 lg:gap-10 lg:mt-9">
      {services.map((service, id) => (
        <div
          key={id}
          className="glassy-screen flex flex-col flex-nowrap justify-center items-center gap-8 px-mobileBound py-7 max-h-[450px] max-w-[350px] w-[100%] sm:px-7 sm:py-8 md:px-8 md:py-9 lg:px-9 lg:py-10"
        >
          <service.Icon />
